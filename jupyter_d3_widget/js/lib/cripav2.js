...
var create = function (that) {
    ...
    that.el.innerHTML = `
        ...
        <div id="container_row3" style="width:950px; height:480px;background-color:#f5f9fa;display: flex;justify-content: center;align-items: center;">
            <div id="group_chart_plot" style="width:920px; height:460px;margin: 10px;background-color:#f0f0f0; overflow-y: scroll; box-shadow: 5px 10px 18px #888888;border: 1px solid;">
            </div>
        </div>
        <div id="container_row4" style="width:950px; height:380px;background-color:#f5f9fa;display: flex;justify-content: center;align-items: center;">
...
var render_group_chart_plot = function(that) {
    ...
    console.log(dataset);
    var divWidth  = document.getElementById("group_chart_plot").clientWidth;
    var divHeight = document.getElementById("group_chart_plot").clientHeight;
    var margin = {top: 10, right: 10, bottom: 10, left: 10};
    
    var width = divWidth - margin.left - margin.right;
    var height = divHeight - margin.bottom - margin.top;

    var Mainsvg = d3.select("#group_chart_plot")
        .append("svg")
        .attr("width", divWidth)
        .attr("height", divHeight)
